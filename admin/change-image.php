...
move_uploaded_file($_FILES["packageimage"]["tmp_name"],"pacakgeimages/".$_FILES["packageimages"]["name"]);
$sql="update tblourPackages set PackageImage=:pimage where PackageId=:imgid";
